...
<!-- Hero Section -->
<section class="relative h-screen bg-cover bg-center flex items-center justify-start px-6 md:px-20" style="background-image: url('images/beranda1.jpg');">
  <!-- Overlay gelap -->
...
<section class="bg-[#3B3A32] py-16 px-4 md:px-10 lg:px-24 text-white">
  ...
  <div id="personal" class="mb-16">
    ...
    <div class="grid md:grid-cols-2 gap-6 items-stretch mb-6">
      <img src="images/personal1.jpg" alt="Personal A dan B" class="rounded-xl shadow-md w-full object-cover h-full max-h-[620px]">
      ...
      <div class="flex flex-col justify-between gap-4">
        ...
        <div class="bg-[#4A4A45] p-5 rounded-xl shadow-lg border-l-4 border-[#E6B800] hover:scale-[1.03] transition duration-300 ease-in-out flex-1 flex flex-col justify-between">
          ...
          <ul class="list-disc ml-4 text-sm text-gray-200 space-y-1 mb-2">
            <?php foreach ($personal_a['deskripsi'] as $item): ?>
              <li><?= esc($item['deskripsi']) ?></li>
            <?php endforeach; ?>
          </ul>
          <div class="text-right mt-2">
            <p class="text-sm text-[#E6B800] font-bold">Rp<?= number_format($personal_a['harga'], 0, ',', '.') ?></p>
            <a href="<?= base_url('pesan') ?>" class="text-sm text-white font-medium hover:text-[#E6B800] transition duration-300 mt-0 block">Pesan Sekarang →</a>
          </div>
        </div>
        ...
        <div class="bg-[#4A4A45] p-5 rounded-xl shadow-lg border-l-4 border-[#E6B800] hover:scale-[1.03] transition duration-300 ease-in-out flex-1 flex flex-col justify-between">
          ...
          <ul class="list-disc ml-4 text-sm text-gray-200 space-y-1 mb-2">
            <?php foreach ($personal_b['deskripsi'] as $item): ?>
              <li><?= esc($item['deskripsi']) ?></li>
            <?php endforeach; ?>
          </ul>
          <div class="text-right mt-2">
            <p class="text-sm text-[#E6B800] font-bold">Rp<?= number_format($personal_b['harga'], 0, ',', '.') ?></p>
            <a href="<?= base_url('pesan') ?>" class="text-sm text-white font-medium hover:text-[#E6B800] transition duration-300 mt-0 block">Pesan Sekarang →</a>
          </div>
        </div>
      </div>
    ...
    <div class="grid md:grid-cols-2 gap-6 items-stretch mb-6">
      <div class="flex flex-col justify-between gap-4">
        ...
        <div class="bg-[#4A4A45] p-5 rounded-xl shadow-lg border-l-4 border-[#E6B800] hover:scale-[1.03] transition duration-300 ease-in-out flex-1 flex flex-col justify-between">
          ...
          <ul class="list-disc ml-4 text-sm text-gray-200 space-y-1 mb-2">
            <?php foreach ($personal_c['deskripsi'] as $item): ?>
              <li><?= esc($item['deskripsi']) ?></li>
            <?php endforeach; ?>
          </ul>
          <div class="text-right mt-2">
            <p class="text-sm text-[#E6B800] font-bold">Rp<?= number_format($personal_c['harga'], 0, ',', '.') ?></p>
            <a href="<?= base_url('pesan') ?>" class="text-sm text-white font-medium hover:text-[#E6B800] transition duration-300 mt-0 block">Pesan Sekarang →</a>
          </div>
        </div>
        ...
        <div class="bg-[#4A4A45] p-5 rounded-xl shadow-lg border-l-4 border-[#E6B800] hover:scale-[1.03] transition duration-300 ease-in-out flex-1 flex flex-col justify-between">
          ...
          <ul class="list-disc ml-4 text-sm text-gray-200 space-y-1 mb-2">
            <?php foreach ($personal_d['deskripsi'] as $item): ?>
              <li><?= esc($item['deskripsi']) ?></li>
            <?php endforeach; ?>
          </ul>
          <div class="text-right mt-2">
            <p class="text-sm text-[#E6B800] font-bold">Rp<?= number_format($personal_d['harga'], 0, ',', '.') ?></p>
            <a href="<?= base_url('pesan') ?>" class="text-sm text-white font-medium hover:text-[#E6B800] transition duration-300 mt-0 block">Pesan Sekarang →</a>
          </div>
        </div>
      </div>

      <img src="images/personal2.jpg" alt="Personal C dan D" class="rounded-xl shadow-md w-full object-cover h-full max-h-[620px]">
    </div>
  </div>
  ...
  <div id="couple">
    ...
    <div class="grid md:grid-cols-3 gap-6">
      ...
      <div class="bg-[#4A4A45] p-5 rounded-xl shadow-lg border-t-4 border-[#E6B800] hover:scale-[1.03] transition duration-300 ease-in-out text-center flex flex-col justify-between">
        <img src="images/bagian8.png" alt="Couple A" class="w-full h-48 object-cover rounded mb-4">
        <div>
          <h4 class="font-semibold text-white mb-2">Couple A</h4>
          <ul class="text-sm text-gray-200 space-y-1 mb-4">
            <?php foreach ($couple_a['deskripsi'] as $item): ?>
              <li><?= esc($item['deskripsi']) ?></li>
            <?php endforeach; ?>
          </ul>
        </div>
        <div class="text-right mt-2">
          <p class="text-sm text-[#E6B800] font-bold">Rp<?= number_format($couple_a['harga'], 0, ',', '.') ?></p>
          <a href="<?= base_url('pesan') ?>" class="text-sm text-white font-medium hover:text-[#E6B800] transition duration-300 mt-0 block">Pesan Sekarang →</a>
        </div>
      </div>
      ...
      <!-- Couple B -->
      <div class="bg-[#4A4A45] p-5 rounded-xl shadow-lg border-t-4 border-[#E6B800] hover:scale-[1.03] transition duration-300 ease-in-out text-center flex flex-col justify-between">
        <img src="images/foto4.png" alt="Couple B" class="w-full h-48 object-cover rounded mb-4">
        <div>
          <h4 class="font-semibold text-white mb-2">Couple B</h4>
          <ul class="text-sm text-gray-200 space-y-1 mb-4">
            <?php foreach ($couple_b['deskripsi'] as $item): ?>
              <li><?= esc($item['deskripsi']) ?></li>
            <?php endforeach; ?>
          </ul>
        </div>
        <div class="text-right mt-2">
          <p class="text-sm text-[#E6B800] font-bold">Rp<?= number_format($couple_b['harga'], 0, ',', '.') ?></p>
          <a href="<?= base_url('pesan') ?>" class="text-sm text-white font-medium hover:text-[#E6B800] transition duration-300 mt-0 block">Pesan Sekarang →</a>
        </div>
      </div>
      ...
      <!-- Couple C -->
      <div class="bg-[#4A4A45] p-5 rounded-xl shadow-lg border-t-4 border-[#E6B800] hover:scale-[1.03] transition duration-300 ease-in-out text-center flex flex-col justify-between">
        <img src="images/bagian5.png" alt="Couple C" class="w-full h-48 object-cover rounded mb-4">
        <div>
          <h4 class="font-semibold text-white mb-2">Couple C</h4>
          <ul class="text-sm text-gray-200 space-y-1 mb-4">
            <?php foreach ($couple_c['deskripsi'] as $item): ?>
              <li><?= esc($item['deskripsi']) ?></li>
            <?php endforeach; ?>
          </ul>
        </div>
        <div class="text-right mt-2">
          <p class="text-sm text-[#E6B800] font-bold">Rp<?= number_format($couple_c['harga'], 0, ',', '.') ?></p>
          <a href="<?= base_url('pesan') ?>" class="text-sm text-white font-medium hover:text-[#E6B800] transition duration-300 mt-0 block">Pesan Sekarang →</a>
        </div>
      </div>
  ...
  <!-- Group Package -->
  <div id="group" class="mt-20">
    <h3 class="text-2xl font-semibold text-white mb-6 border-l-4 border-[#E6B800] pl-3">Group Package</h3>
    <div class="grid md:grid-cols-3 gap-6">

      <!-- Group A -->
      <div class="bg-[#4A4942] p-5 rounded-xl shadow-lg border-t-4 border-[#E6B800] hover:scale-[1.02] transition duration-300 ease-in-out">
        <img src="images/footer.png" alt="Group A" class="w-full h-48 object-cover rounded-md mb-4 shadow-sm">
        <h4 class="font-semibold text-white text-lg mb-2">Group A</h4>
        <ul class="text-sm text-white list-disc ml-4 space-y-1">
          <?php foreach ($group_a['deskripsi'] as $item): ?>
            <li><?= esc($item['deskripsi']) ?></li>
          <?php endforeach; ?>
        </ul>
        <div class="text-right mt-4">
          <p class="text-sm text-[#E6B800] font-bold">Rp<?= number_format($group_a['harga'], 0, ',', '.') ?></p>
          <a href="<?= base_url('pesan') ?>" class="text-sm text-white font-medium hover:text-[#E6B800] transition">Pesan Sekarang →</a>
        </div>
      </div>

      <!-- Group B -->
      <div class="bg-[#4A4942] p-5 rounded-xl shadow-lg border-t-4 border-[#E6B800] hover:scale-[1.02] transition duration-300 ease-in-out">
        <img src="images/foto6.png" alt="Group B" class="w-full h-48 object-cover rounded-md mb-4 shadow-sm">
        <h4 class="font-semibold text-white text-lg mb-2">Group B</h4>
        <ul class="text-sm text-white list-disc ml-4 space-y-1">
          <?php foreach ($group_b['deskripsi'] as $item): ?>
            <li><?= esc($item['deskripsi']) ?></li>
          <?php endforeach; ?>
        </ul>
        <div class="text-right mt-4">
          <p class="text-sm text-[#E6B800] font-bold">Rp<?= number_format($group_b['harga'], 0, ',', '.') ?></p>
          <a href="<?= base_url('pesan') ?>" class="text-sm text-white font-medium hover:text-[#E6B800] transition">Pesan Sekarang →</a>
        </div>
      </div>
      ...
      <!-- Group C -->
      <div class="bg-[#4A4942] p-5 rounded-xl shadow-lg border-t-4 border-[#E6B800] hover:scale-[1.02] transition duration-300 ease-in-out">
        <img src="images/bagian6.png" alt="Group C" class="w-full h-48 object-cover rounded-md mb-4 shadow-sm">
        <h4 class="font-semibold text-white text-lg mb-2">Group C</h4>
        <ul class="text-sm text-white list-disc ml-4 space-y-1">
          <?php foreach ($group_c['deskripsi'] as $item): ?>
            <li><?= esc($item['deskripsi']) ?></li>
          <?php endforeach; ?>
        </ul>
        <div class="text-right mt-4">
          <p class="text-sm text-[#E6B800] font-bold">Rp<?= number_format($group_c['harga'], 0, ',', '.') ?></p>
          <a href="<?= base_url('pesan') ?>" class="text-sm text-white font-medium hover:text-[#E6B800] transition">Pesan Sekarang →</a>
        </div>
      </div>
    ...
    <!-- Bundling & Additional -->
    <div id="bundling" class="mt-20">
      <h3 class="text-2xl font-semibold text-white mb-6 border-l-4 border-[#E6B800] pl-3">Bundling & Additional</h3>
      <div class="grid md:grid-cols-2 gap-6">
        ...
        <div class="bg-[#4A4942] p-5 rounded-xl shadow-lg border-t-4 border-[#E6B800] hover:scale-[1.02] transition duration-300 ease-in-out">
          ...
          <ul class="text-sm text-white list-disc ml-4 space-y-1">
            <?php foreach ($bundling_video['deskripsi'] as $item): ?>
              <li><?= esc($item['deskripsi']) ?></li>
            <?php endforeach; ?>
          </ul>
          <div class="text-right mt-4">
            <p class="text-sm text-[#E6B800] font-bold">Rp<?= number_format($bundling_video['harga'], 0, ',', '.') ?></p>
            <a href="<?= base_url('pesan') ?>" class="text-sm text-white font-medium hover:text-[#E6B800] transition">Pesan Sekarang →</a>
          </div>
        </div>
        ...
        <div class="bg-[#4A4942] p-5 rounded-xl shadow-lg border-t-4 border-[#E6B800] hover:scale-[1.02] transition duration-300 ease-in-out">
          ...
          <ul class="text-sm text-white list-disc ml-4 space-y-1">
            <?php foreach ($additional['deskripsi'] as $item): ?>
              <li><?= esc($item['deskripsi']) ?></li>
            <?php endforeach; ?>
          </ul>
        </div>
